        ...
        <div class="backdrop">
            ...
            <div class="box-area">
                <div class="single-box">
                    ...
                    <div class="img-text">
                        <p>To help you assess your resilience.<br>Find out where you stand.</br></p>
                    </div>
                </div>
                ...
                <div class="single-box">
                    <div class="img-area"></div>
                    <div class="img-text">
                        <p>To help protect your stakeholders<br>Because your success depends on them.</br></p>
                    </div>
                </div>
                ...
                <div class="single-box">
                    <div class="img-area"></div>
                    <div class="img-text">
                        <p>To help build the industry<br>Because when you are resilient,<br>you help the industry become more resilient.</br></p>
                    </div>
                </div>
                ...
                <div class="single-box">
                    <div class="img-area"></div>
                    <div class="img-text">
                        <p>Because the country needs you to be resilient<br>The whole country benefits from you moving towards a more resilient future.</br></p>
                    </div>
                </div>
            </div>
